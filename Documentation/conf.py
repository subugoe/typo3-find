...
project = u'TYPO3 Find'
copyright = u'2015, Sven-S. Porst, Ingo Pfennigstorf'
...
latex_documents = [
    ('Index', 'find.tex', u'TYPO3 Find',
     u'Sven-S. Porst, Ingo Pfennigstorf', 'manual'),
]
...
pdf_documents = [
    ('Index', 'find', u'TYPO3 Find',
     u'Sven-S. Porst, Ingo Pfennigstorf'),
]
...
man_pages = [
    ('Index', 'find', u'TYPO3 Find',
     [u'Sven-S. Porst, Ingo Pfennigstorf'], 1)
]
...
texinfo_documents = [
    ('Index', 'find', u'TYPO3 Find',
     u'Sven-S. Porst, Ingo Pfennigstorf', 'TYPO3 Find', 'One line description of project.',
     'Miscellaneous'),
]
