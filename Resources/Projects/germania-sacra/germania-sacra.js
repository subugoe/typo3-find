...
var germaniaSacra = (function () {
	...
	var addNearby = function (map, queryURL) {
		var iconForStandort = function (standortInfo, ordenInfos) {
			...
			if (matchingOrden.length === 1 && matchingOrden[0].graphik !== '') {
				...
				var iconURL = 'http://vlib.sub.uni-goettingen.de/test/typo3conf/ext/find/Resources/Projects/germania-sacra/Ordenssymbole/' + fileName + '.png';
	...
	var addBistumsgrenzen = function (map) {
		var baseURL = 'http://vlib.sub.uni-goettingen.de/test/typo3conf/ext/find/Resources/Projects/germania-sacra/Bistumsgrenzen/';
